# Example 7 (Python)
# Remarks
# This example was created using Python 3.4.3. It is based on the Sap2000 verification problem Example 1-001.
#
...
#
# Example
# 1. Download and install Python 3.4.3 or higher for Windows. Python is freely available at python.org.
#
# 2. Install the Python package "comtypes". If you are using Python 3.4 or higher, the easiest way to do this is by
# opening a command prompt with administrative privileges and entering the command:
#
...
#
# 3. Create a Python .py file using IDLE or any text editor and paste in the following code. Please pay attention to
# the comments in this code block; they contain important information about running the script.
